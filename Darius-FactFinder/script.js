...
function showfacta(){
	document.getElementById('facts').innerHTML = "<h3>" + a + "</h3>" + "<img src='images/fish.gif' alt='fish'>";
}
...
function showfactb(){
	document.getElementById('facts').innerHTML = "<h3>" + b + "</h3>" + "<img src='images/avacado.gif' alt='avacado'>";
}
...
function showfactc(){
	document.getElementById('facts').innerHTML = "<h3>" + c + "</h3>" + "<img src='images/ketchup.gif' alt='ketchup'>";
}
...
function showfactd(){
	document.getElementById('facts').innerHTML = "<h3>" + d + "</h3>" + "<img src='images/j.gif' alt='letter j'>";
}
...
function showfacte(){
	document.getElementById('facts').innerHTML = "<h3>" + e + "</h3>" + "<img src='images/cat.gif' alt='cat'>";;
